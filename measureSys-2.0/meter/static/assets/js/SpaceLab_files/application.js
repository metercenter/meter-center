...
function add___________ngRoute___________Start(){};
...
function CompanyPageCtrl($scope) {
  alert('nihao');
};
function UserPageCtrl($scope) {
  
};
function MeterPageCtrl($scope) {
  
};
function add___________ngRoute___________End(){};
...
app.controller('AddUserModalInstanceCtrl', function ($scope, $http, $modalInstance, items) {//
